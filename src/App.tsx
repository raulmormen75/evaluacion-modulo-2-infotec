    ...
    return (
      <div className="app-shell">
        <main className="content-stack">
          <SectionCard
            step="Carga"
            title="Preparando la evaluación"
            instructions="Estamos verificando la sesión local antes de mostrar los reactivos."
            state="active"
          >
      ...
      <main className="content-stack">
        {isIntegrityLocked ? (
          <SectionCard
            ...
            instructions="Se detectó una alteración del progreso o un intento de reinicio fuera del flujo permitido."
            state="locked"
          >
            <div className="security-panel" role="alert">
              <p className="security-message">
                {snapshot.integrityMessage ??
                  'La evaluación quedó bloqueada para proteger la integridad de la calificación final.'}
              </p>
              <p className="security-note">
                Esta versión no tiene backend. Aun así, la app registra firma local y control anti-rollback para elevar la
                dificultad de manipulación en este navegador.
              </p>
            </div>
          </SectionCard>
        ) : (
          <>
            <SectionCard
              ...
              instructions="Trabaja un tema por vez. El siguiente tema se desbloquea cuando aciertas las 5 relaciones del actual."
              state={matchResolved === 25 ? 'completed' : 'active'}
            >
              {matchResolved === 25 ? (
                <p className="locked-message">Los cinco temas quedaron completos en esta actividad.</p>
              ) : (
            ...
            <SectionCard
              ...
              instructions="Verás una sola pregunta por vista. Si fallas, vuelves a intentarlo hasta acertar."
            ...
            <SectionCard
              ...
              instructions="Desliza la tarjeta o usa las flechas del teclado. Si fallas, repites el mismo enunciado."
            ...
            {activeSection === 'final' ? (
              <SectionCard
                step="Actividad 4"
                title="Calificación final y descarga de evidencia"
                instructions="Captura tu nombre completo y genera la evidencia en PNG."
                state="active"
              >
